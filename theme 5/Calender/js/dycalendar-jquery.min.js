...
! function (a, t) {
    ...
    function e(a, e) {
        var d, n, r, o, l, y;
        for (d = t("<table>"), n = t("<tr>"), l = 0; l <= 6; l += 1)(r = t("<td>")).html("SMTWTFS"[l]), n.append(r);
        for (d.append(n), n = t("<tr>"), l = 0; l <= 6 && l !== a.firstDayIndex; l += 1) r = t("<td>"), n.append(r);
        for (y = 1; l <= 6;)(r = t("<td>")).html(y), a.today.date === y && a.today.monthIndex === a.monthIndex && !0 === e.highlighttoday && r.addClass("dycalendar-today-date"), e.date === y && e.month === a.monthIndex && !0 === e.highlighttargetdate && r.addClass("dycalendar-target-date"), n.append(r), y += 1, l += 1;
        for (d.append(n), o = 3; o <= 7; o += 1) {
            for (n = t("<tr>"), l = 0; l <= 6; l += 1) {
                if (y > a.totaldays) return d.append(n), d;
                (r = t("<td>")).html(y), a.today.date === y && a.today.monthIndex === a.monthIndex && !0 === e.highlighttoday && r.addClass("dycalendar-today-date"), e.date === y && e.month === a.monthIndex && !0 === e.highlighttargetdate && r.addClass("dycalendar-target-date"), y += 1, n.append(r)
            }
            d.append(n)
        }
        return d
    ...
    function l(e) {
        ...
        switch (e.type) {
            case "day":
                r = n(o(e.year, e.month, e.date), e);
                break;
            case "month":
                r = d(o(e.year, e.month, e.date), e);
                break;
            default:
                return a.console.error("Invalid type"), !1
        }
        t(e.target).html(r)
    }
    var y = {},
    ...
    y.draw = function (t) {
        if (void 0 === t) return a.console.error("Option missing"), !1;
        var e = new Date;
        l(t = r(t, {
            type: "day",
            month: e.getMonth(),
    ...
    }, t("body").on("click", ".dycalendar-prev-next-btn", function (a) {
        a.preventDefault();
        var e = t(this).data("date"),
            d = t(this).data("month"),
            n = t(this).data("year"),
            r = t(this).data("btn"),
            o = t(this).parent().data("option");
        "prev" === r ? (d -= 1) < 0 && (n -= 1, d = 11) : "next" === r && (d += 1) > 11 && (n += 1, d = 0), o.date = e, o.month = d, o.year = n, l(o)
    }), t("body").on("click", ".dycalendar-span-month-year", function (a) {
        a.preventDefault();
        var e = t(this).parent().data("option"),
            d = new Date;
        e.date = d.getDate(), e.month = d.getMonth(), e.year = d.getFullYear(), l(e)
    }), a.dycalendar = y
}("undefined" != typeof window ? window : this, "undefined" != typeof jQuery ? jQuery : void 0);